...
namespace uSlack.Tests
{
    ...
    public class SecurityTests
    {
        ...
        public void SlackSignatureShouldBeValid_demoData()
        {
            ...
            var isValid = Security.Security.IsValidSlackSignature(1531420618, payload, slackSignature, signingSecret);
        ...
        public void SlackSignatureShouldBeValid_realData()
        {
            ...
            var isValid = Security.Security.IsValidSlackSignature(timespan, payload, slackSignature, signingSecret);
